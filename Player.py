...
class Player:
    ...
    def add_song(self):
        ...
        if song_path == "":
            return
        for self.song_path1 in song_path:
            song_name=os.path.basename(self.song_path1)
            self.song_names.append(os.path.basename(self.song_path1))

            self.my_model.add_song(song_name,self.song_path1)
